...
shape_after = [batch_size, 4, hidden//2, hidden//2]
shape = [batch_size, hidden, hidden, 4]
mock_config = MockConfig()
# create AIT model
ait_model = AITVitMatteBasicConv3x3(mock_config, in_channels=4, out_channels=4, stride=2, padding=1)
...
# create pt model
pt_model = VitMatteBasicConv3x3(mock_config, in_channels=4, out_channels=4, stride=2, padding=1).cuda().half()
